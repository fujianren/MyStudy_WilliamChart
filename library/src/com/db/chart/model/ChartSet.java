 ...
 * 一个以ChartEntry为元素的集合，即封装了曲线上的点的集合，及曲线的属性
 */
public abstract class ChartSet {
	...
	/** Set with entries */
	final private ArrayList<ChartEntry> mEntries;		// ChartEntry集合
	
	
	/** Paint alpha value from 0 to 1 画笔渐变值0~1*/
	private float mAlpha;
	
	
	/** Whether the set will be visible or not 集合是否可见，默认不可见*/
