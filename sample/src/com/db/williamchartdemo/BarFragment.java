...
public class BarFragment extends Fragment {
    ...
    public void produceOne(ChartView chart, Runnable action){
        ...
        barChart.setSetSpacing(Tools.fromDpToPx(-15));          // 横轴间距
        barChart.setBarSpacing(Tools.fromDpToPx(35));
        barChart.setRoundCorners(Tools.fromDpToPx(2));          // 柱形图圆角
        ...
        barChart.setBorderSpacing(5)                                // 左右padding5
                .setAxisBorderValues(0, 10, 2)                      // 取值0~10，间距2
                .setGrid(BarChartView.GridType.FULL, gridPaint)     // 画出所有网格
